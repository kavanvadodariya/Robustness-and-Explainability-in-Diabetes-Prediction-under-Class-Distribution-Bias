...
# Remove dominant biomarkers (as decided)
...
# Undersample non-diabetic to match diabetic count
df_nondiab = df_nondiab.sample(
    n=len(df_diab),
    random_state=42
)

df_balanced = pd.concat([df_diab, df_nondiab]).sample(
